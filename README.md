# PyESAPI
*"A passion project to help accelerate breakthroughs in medical physics research by bringing the power of Python into the Eclipse API ecosystem."  -Michael Folkerts, Software Engineer, Varian Medical Systems*
